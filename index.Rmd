...
## 'generate_new_design' generates a new set of parameters for the next wave of the history matching process. The argument 'n_points' specifies how many points are to be generated.
